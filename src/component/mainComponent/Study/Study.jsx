...
function Study() {
  ...
  return (
    <div id={pageIndex.current_study} className="study">
      <Menu />
      ...
      <div className="box">
        <div className="column">
          ...
          <p className="sub-desc">
            공부하면서 새롭게 배운 용어들이나 문법, 관련 코드등을 'Figma'를
            사용하여 정리하였습니다.
          </p>
        </div>
        <div className="column">
          ...
          <div className="image-box">
            ...
            <div className="links">
              <a
                href="https://github.com/jangar6/dothome1"
                target="_blank"
                rel="noopener noreferrer"
              >
                GitHub
              ...
              <a
                href="https://jangar6.github.io/dothome1"
                target="_blank"
                rel="noopener noreferrer"
              >
                Home
          ...
          <p className="sub-desc">
            퍼블리셔를 준비할 당시 공부한 내용을 정리하고 기록하였습니다.
          </p>
        </div>
        <div className="column">
          <p className="desc">GitBoock</p>
          <div className="image-box">
            <div className="image gitBook" />
            <div className="links">
              <a
                href="https://jangar6621.gitbook.io/javascript/"
                target="_blank"
                rel="noopener noreferrer"
              >
                생활코딩
              ...
              <a
                href="https://jangar6621.gitbook.io/javascript-jquery/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Javascript
              ...
              <a
                href="https://jangar6621.gitbook.io/jquery-1/"
                target="_blank"
                rel="noopener noreferrer"
              >
                JQuery
              ...
              <a
                href="https://jangar6621.gitbook.io/react/"
                target="_blank"
                rel="noopener noreferrer"
              >
                React
              ...
              <a
                href="https://jangar6621.gitbook.io/vue/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Vue
          ...
          <p className="sub-desc">
            기초적인 문법과 다양한 공부한 내용들을 'GitBoock'을 사용하여
            기록하였습니다.
          </p>
        </div>
        <div className="column">
          <p className="desc">Tistory</p>
          <div className="image-box">
            <div className="image tistory" />
            <div className="links">
              <a
                href="https://j3a1.tistory.com/"
                target="_blank"
                rel="noopener noreferrer"
              >
                Tistory
          ...
          <p className="sub-desc">
            입사 후 주니어 개발자들끼리 스터디한 내용들과 개발 지식을 공유했던
            사이트입니다.
          </p>
        </div>
        <div className="column">
          <p className="desc">Codepen</p>
          <div className="image-box">
            <div className="image">
              <StudyAni />
            </div>
            <div className="links">
              <a
                href="https://codepen.io/your-work?cursor=ZD0xJm89MCZwPTEmdj00OTE3NjQ0OQ=="
                target="_blank"
                rel="noopener noreferrer"
              >
                CodePen
          ...
          <p className="sub-desc">
            처음에는 퍼블적인 기술을 기록하였으나 현재는 입사 후 필요한 기술들을
            테스트하는 용도로 사용중입니다.
          </p>
        </div>
      </div>
